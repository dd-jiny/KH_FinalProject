...
public class NaverLoginBo {
	...
	// URL�� ������ �����Դϴ�.
	// state: ���ø����̼��� ������ ���� ��ū
	private final static String CLIENT_ID = "QNwihdTq_OtCP0TU4Hcg";
	private final static String CLIENT_SECRET = "ufI7DCnz9x";
	private final static String REDIRECT_URI = "http://localhost:8787/carrot/naverlogincallback.do";
